...
public class ElevatorTests {
    ...
    @Test
    void pickUpTest() {
        val elevator = Elevator.of(1, 0, new ArrayList<>());
        elevator.pickup(2, 5);
        assertEquals(5, elevator.getTargetLevel());
        assertEquals(List.of(5, 2), elevator.getRoad());
        elevator.pickup(3, 4);
        assertEquals(List.of(5, 2, 3, 4), elevator.getRoad());
        elevator.pickup(6, 8);
        assertEquals(List.of(8, 6, 5, 2, 3, 4), elevator.getRoad());
    }
    ...
    void stepTest() {
        ...
        assertEquals(5, elevator.getCurrentLevel());
        elevator.pickup(4, 2);
        assertEquals(List.of(2, 4), elevator.getRoad());
        assertEquals(5, elevator.getCurrentLevel());
